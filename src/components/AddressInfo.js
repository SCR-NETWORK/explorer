        ...
        <Container className="webpage addressinfo-box" fluid>
            ...
            <Row>
                <Col md={12} className="mt-sm-4">
                    ...
                    <div className="utxo-value-mono"><span class="addressinfo-color">pyrin:</span>{addr.substring(6, addr.length - 8)}<span class="addressinfo-color">{addr.substring(addr.length - 8)}</span>
